        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Expiration = table.Column<string>(type: "character varying(5)", maxLength: 5, nullable: false),
                    ...
                    ZipCode = table.Column<string>(type: "character varying(13)", maxLength: 13, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PerformedBy = table.Column<string>(type: "character varying(450)", maxLength: 450, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PermissionAuditLogs_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PermissionAuditLogs_EntityType_EntityId",
                table: "PermissionAuditLogs",
                columns: new[] { "EntityType", "EntityId" });

            migrationBuilder.CreateIndex(
                name: "IX_PermissionAuditLogs_PerformedBy",
                table: "PermissionAuditLogs",
                column: "PerformedBy");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Permissions_ServiceName_ResourceType_Action",
                table: "Permissions",
                columns: new[] { "ServiceName", "ResourceType", "Action" });
